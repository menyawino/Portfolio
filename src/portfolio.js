...
const skillsSection = {
  title: "What I do",
  subTitle:
    "BUILDING BOLD SOLUTIONS AND LEVERAGING EMERGING TECHNOLOGIES TO TACKLE LIFE SCIENCES' TOUGHEST CHALLENGES",
  skills: [
    emoji(
    ...
    emoji("⚡ Building AI/ML models for bioinformatics and omics data"),
    emoji(
  ...
  schools: [
    {
      ...
      subHeader:
        "B.S. in Molecular and Cell Biology, with minors in Bioinformatics and Chemistry",
  ...
  projects: [
    {
      ...
      projectDesc:
        "Developing a metagenomics testing platform powered with generative AI.",
      footerLink: [
        {
          name: "Visit Website",
    ...
    },
    {
      ...
      projectDesc:
        "Building an AI-powered fitness platform to help users achieve their fitness goals.",
      footerLink: [
        {
          name: "Coming soon!"
          // url: "http://nextu.se/"
...
const achievementSection = {
  ...
  achievementsCards: [
    ...
    },
    {
      ...
      image: require("./assets/images/garnLogo.png"),
    ...
    },
    {
      ...
      subtitle:
        "Built a functioning total artificial heart, integrating machine learning algorithms to optimize heart function.",
